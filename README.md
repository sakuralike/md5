...
> 当前阶段：M4 核心闭环、N1 用户安全/隐私和 N2 管理员治理保持完成；WP1 前端规范欠账已收口，WP2 第 1 轮已建立账号申诉创建、本人案件详情和统一案件主体基线。独立案件指派/原子处置/重开、结果通知和 Web 账号申诉交互仍待后续轮次。项目只使用合成测试数据，禁止提交真实密码、访问令牌或生产密钥。
