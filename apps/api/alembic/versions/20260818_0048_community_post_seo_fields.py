...
def upgrade() -> None:
    ...
    op.add_column(
        "community_posts", sa.Column("seo_description", sa.String(length=320), nullable=True)
    )
    op.add_column("community_posts", sa.Column("seo_keywords", sa.JSON(), nullable=True))
    op.add_column(
        "community_posts", sa.Column("seo_canonical_path", sa.String(length=512), nullable=True)
    )
    op.add_column(
        "community_posts", sa.Column("og_image_url", sa.String(length=1024), nullable=True)
    )
    op.add_column(
        "community_posts",
