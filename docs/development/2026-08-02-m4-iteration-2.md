...
- 功能提交：`53ba900 feat: add M4 report and appeal workflow`。
- 堆叠 PR：[PR #17](https://github.com/sakuralike/md5/pull/17)，基于 `codex/m4-candidate-moderation`（PR #16）。
- Pull request CI 运行 `30752802023` 已通过；API、Frontend、Desktop 和 Container Images 四个作业全部成功，其中 API 同时完成 SQLite 与 MySQL 8.4 全量迁移往返。
