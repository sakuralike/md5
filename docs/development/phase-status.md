...
- 最近迭代：[M3 第 2 次开发迭代](./2026-08-02-m3-iteration-2.md)
...
| 自动化门禁 | 本轮完成 | 后端 6 个 M3 专项测试、桌面 10 个安全与样本矩阵测试、统一门禁、迁移往返、Docker/MySQL 空环境冒烟及 PR #15 GitHub CI 全部通过 |
...
- [x] 本轮 PR #15 GitHub CI 的 API、Frontend、Desktop（Release 构建与 10 个测试）和 Container Images 全部通过。
