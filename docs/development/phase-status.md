...
- 更新日期：2026-08-08
- 当前里程碑：N2 管理员治理中心
- 最近迭代：[N2 第 8 次开发迭代：WP1 前端质量门禁与用户基础流程首批整改](./2026-08-08-n2-iteration-8.md)
...
> 2026-08-08 本轮 N2 第 8 次迭代提前启动 WP1：根/Web/Admin ESLint、业务 Vue 规范策略、`pnpm lint`、GitHub Actions 和 PowerShell 5.1 兼容入口已建立；App、首页、注册页完成首批 Shadcn-Vue 迁移并新增首页 SSR 渲染测试。历史前端规范欠账从 164 项降至 141 项，新增违规为 0；WP1 总体仍在进行中，本地门禁通过不等于浏览器 E2E、真实目标环境或生产放行完成。
