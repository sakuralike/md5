...
- 更新日期：2026-08-02
- 当前里程碑：M4 社区信任与管理闭环
- 最近迭代：[M4 第 1 次开发迭代](./2026-08-02-m4-iteration-1.md)
...
| 维度 | 工程估算 | 说明 |
|---|---:|---|
| 功能代码完成度 | 约 78% | M1、M2、M3 主流程和 M4 候选人工审核首版已形成；举报、信誉、申诉、告警和 M5 发布工程仍有明显缺口 |
| MVP 验收完成度 | 约 62% | 自动化门禁与 M4 审核专项测试稳定，但浏览器 E2E、实机桌面 E2E、规模压测和生产密钥验收未完成 |
...
| M4 社区信任与管理闭环 | 约 35% | 候选筛选、最小披露详情、人工状态处置、幂等和审计首版完成；举报、信誉、申诉、告警和用户处置未实现 |
