...
- 最近迭代：[WP4 第 20 次开发迭代：Staging 长时稳定性会话编排与短时实测](./2026-08-11-wp4-iteration-20.md)
- 前次迭代：[WP4 第 19 次开发迭代：Staging 资源观测采集器与证据边界](./2026-08-11-wp4-iteration-19.md)
...
| MVP 验收完成度 | 约 97% | 三浏览器 90 项旅程、依赖/SAST/SBOM、最终镜像、仓库 Secret、风险接受、匿名/普通用户对象边界和管理员 MFA/再认证/幂等动态门禁已形成自动门禁；Edge、真实 Safari、NVDA/VoiceOver、真实移动设备、跨区域恢复、规模压测、真实 SMTP 服务商/发件域名和生产密钥验收未完成 |
| 生产上线准备度 | 约 67% | 容器、迁移、CI、依赖/SAST/SBOM、最终镜像与 Secret 阻断、风险接受和管理员认证动态门禁已建立；完整 BOLA、人工渗透、发件域名、指标出口、监控平台、跨区域恢复、密钥轮换、合规和灰度发布尚未闭环 |
