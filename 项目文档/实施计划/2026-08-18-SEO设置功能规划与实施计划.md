...
> **For agentic workers:** REQUIRED SUB-SKILL: Use `superpowers:executing-plans` or `superpowers:subagent-driven-development` to implement this plan task-by-task after the plan is approved. This document is currently a planning artifact; this round does not implement SEO code.
