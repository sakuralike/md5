...
| 社区搜索 | 未实现 | 本计划 WP5-I8 |
| 私信、站内聊天 | WP5-I9 异步基础已实现并完成本地浏览器验收 | 一对一会话、AES-GCM、收件箱、已读、归档/静音、屏蔽；实时与治理留待 WP5-I10 |
...
- WP5-I9 本地代码与自动化闭环完成；远端同步和 Staging 发布证据在本轮部署后补记。WP5-I10 实时 Pub/Sub、消息举报和治理能力仍未完成，UAT/Production 未验收。
