...
| 社区搜索 | 未实现 | 本计划 WP5-I8 |
| 私信、站内聊天 | WP5-I9 异步基础已完成本地/远端/Staging 验收；WP5-I10 实时事件已完成本地实现与自动化 | 一对一会话、AES-GCM、收件箱、已读、归档/静音、屏蔽，以及 MySQL 持久事件、Redis 唤醒、独立 SSE 和游标补偿；WP5-I10 远端/Staging 待本轮发布，消息举报和批量发送风控仍待后续，UAT/Production 未验收 |
