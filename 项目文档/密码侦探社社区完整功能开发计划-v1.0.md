...
| 社区搜索 | 未实现 | 本计划 WP5-I8 |
| 私信、站内聊天 | WP5-I9 异步基础与 WP5-I10 消息举报/批量冷却已完成本地实现与自动化 | 一对一会话、AES-GCM、收件箱、已读、归档/静音、屏蔽、消息举报最小披露、持久化 15 分钟冷却、MySQL 持久事件、Redis 唤醒、独立 SSE 和游标补偿；WP5-I10 新迁移和治理接口待 Staging 发布，UAT/Production 未验收 |
